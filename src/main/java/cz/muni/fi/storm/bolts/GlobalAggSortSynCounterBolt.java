 ...
 * (for tcp syn flags ip) from local bolts and sends result to kafka.
 * Output kafka topic is extracted from configuration of storm.
 */
public class GlobalAggSortSynCounterBolt extends BaseRichBolt {
     ...
     */
    public GlobalAggSortSynCounterBolt(int totalSenders) {
     ...
     * - sortPackets.synTopN first top n sorted count per ip
     */
    @Override
    public void prepare(Map stormConf, TopologyContext context, OutputCollector collector) {
        ...
        this.topN = new Integer(stormConf.get("sortPackets.synTopN").toString());
    }
